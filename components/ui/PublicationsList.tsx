        ...
        <div key={year} className="space-y-8">
          ...
          <div className="space-y-8">
            {publicationsByYear[year].map((pub) => (
              <article key={pub.id} className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-500 mb-4 flex items-center space-x-2">
                      ...
                      {pub.type && (
                        <>
                          <span className="mx-2">•</span>
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-softBlue-100 text-softBlue-800">
                    ...
                    {pub.link && (
                      <a
                        ...
                        className="inline-flex items-center text-softBlue-600 hover:text-softBlue-800"
                      >
                        Read Paper
                        <svg
